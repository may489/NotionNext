...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mayia', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个真正的霞光🧰', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mayia498.com', // 网站地址
